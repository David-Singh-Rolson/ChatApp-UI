    ...
    >
      {theme === "light" ? (
        ...
        <svg
          ...
          className="h-6 w-6 text-gray-800 transition-transform duration-300 hover:rotate-12"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6 text-yellow-400 transition-transform duration-300 hover:rotate-180"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
